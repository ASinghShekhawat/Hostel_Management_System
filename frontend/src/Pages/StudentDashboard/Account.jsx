...
import { Row, Col, Button, Input, Card, CardBody, CardHeader } from "reactstrap";
...
class Account extends React.Component {
  ...
  fetchAccountDetails = () => {
    ...
    axios
      .get(`http://localhost:3001/student/account/${userId}`)
      .then((res) => {
  ...
  handleSave = () => {
    ...
    axios
      .put(`http://localhost:3001/student/account/${userId}`, {
  ...
  handlePasswordUpdate = () => {
    ...
    axios
      .put(`http://localhost:3001/student/updatePassword/${userId}`, {
        currentPassword,
        newPassword,
      })
      .then((res) => {
